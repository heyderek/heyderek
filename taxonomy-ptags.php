      ...
      <section class="work">
         <div class="wrapper">
            <header class="page-tag-blue grey-double-border">
              <h3 class="blue"><?php printf( __( 'Tag : %s', 'toolbox' ), '<span>' . single_tag_title( '', false ) . '</span>' ); ?></h3>
            </header><!-- /.page-tag-wrap -->
            <?php 
              $tag_description = tag_description();
              if ( ! empty( $tag_description ) ) echo apply_filters( 'tag_archive_meta', '<h4 class="content description">' . $tag_description . '</h4>' );
            ?>
            <ul class="gallery">
